                ...
                for folder in d[1]:
                    ...
                    for j in range(len(zips)):
                        for i in range(len(filenames)):
                            ...
                            cv2.imwrite(self.coco_path+'/'+filename, im)
                            ...
                            for a in roi_list:
                                ...
                                try:
                                    ...
                                    if file_num == roi_num:
                                        ...
                                        # parameters
                                        x_list.append(a["x"][0]/4)
                                        y_list.append(a["y"][0]/4)
                                        regions = {
                                            str(a): {
                                                "shape_attributes": {
                                                    "name": "polygon",
                                    ...
                                    if a['type']=="line":
                                        ...
                                        new_x_list.append(int(x1-(weight[1]))/4)
                                        new_x_list.append(int(x1+(weight[1]))/4)
                                        new_x_list.append(int(x2-(weight[0]))/4)
                                        new_x_list.append(int(x2+(weight[0]))/4)
                                        new_x_list.append(int(x1-(weight[1]))/4)
                                        new_y_list.append(int(y1-(weight[1]*slope_a))/4)
                                        new_y_list.append(int(y1+(weight[1]*slope_a))/4)
                                        new_y_list.append(int(y2-(weight[0]*slope_a))/4)
                                        new_y_list.append(int(y2+(weight[0]*slope_a))/4)
                                        new_y_list.append(int(y1-(weight[1]*slope_a))/4)
                                        ...
                                        for i in range(angles):
                                            phi+=angle_shift
                                            x_list.append(int(center_x + (a['width'] * np.cos(phi)/2))/4)
                                            y_list.append(int(center_y + (a['height'] * np.sin(phi)/2))/4)
                                        regions = {
                                            str(a): {
                                                "shape_attributes": {
                                                    "name": "polygon",
